(function() {
  ...
  angular
    .module('teambookWww')
    .directive('memberShares', memberShares);
  ...
  function memberShares() {
    var directive = {
      restrict: 'E',
      templateUrl: 'app/member/memberShares/member_shares.html',
      scope: {},
      controller: MemberSharesController,
      controllerAs: 'vm',
    ...
    /** @ngInject */
    function MemberSharesController($location,usershares,user) {
        var vm = this;
        var userId;
